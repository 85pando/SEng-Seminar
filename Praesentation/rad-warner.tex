...
\begin{tikzpicture}
\note<1>{Now for the examples for stimuli:}
\note<2>{we have this room with an reactor inside}
\note<3>{because several people work here, we put several rooms around the reactor \\ walls are shielded}
\note<4>{because people work here, we need some sensors to detect radiation leaks}
%shielding
