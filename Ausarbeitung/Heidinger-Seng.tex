...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Assessment}
During my internship at the Paul Scherrer Institute I produced an Embedded System without any specific knowledge of Software Engineering or the special requirements for Embedded Systems themselves.
...
Embedded System design is a very broad field, as Embedded Systems do themselves have a huge variety in how they are built, how they work and what they do, so that a single chapter will only be able to provide a lookout into this field.
When planning to work into this field, more specific study will be required and in the end success will hugely depend upon how well you are able to decide the steps needed for your system.
